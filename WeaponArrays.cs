...
namespace UniversalLobCorpTTK
{
    public static class WeaponArrays
    {
        ...
        public readonly static String[] Penitence = new string[7] { "Penitence", "Zayin", "White", "5", "7", "1", "0.5" };

        public readonly static String[] Soda = new string[7] { "Soda", "Zayin", "Red", "1", "2", "1", "1.5" };

        public readonly static String[] Tough = new string[7] { "Tough", "Zayin", "White", "2", "4", "1", "1.5" };

        public readonly static String[] Wingbeat = new string[7] { "Wingbeat", "Zayin", "Red", "5", "7", "1", "0.5" };

        public readonly static String[] Pink = new string[7] { "Pink", "ALEPH", "White", "20", "24", "1", "0.5" }; //+15% min max with full suit
        ...
        public readonly static String[] ScreamingWedge = new string[7] { "Screaming Wedge", "HE", "White", "5", "7", "1", "0.75" };
        
        public readonly static String[] RedEyes = new string[7] { "Red Eyes", "TETH", "Red", "7", "9", "1", "0.5" };
        
        public readonly static String[] Horn = new string[7] { "Horn", "TETH", "Red", "5", "7", "1", "0.67" };
        
        public readonly static String[] WristCutter = new string[7] { "Wrist Cutter", "TETH", "White", "2", "3", "1", "1.75" };
        
        public readonly static String[] Regret = new string[7] { "Regret", "TETH", "Red", "10", "15", "1", "0.33" };
        
        public readonly static String[] Beak = new string[7] { "Beak", "TETH", "Red", "2", "3", "1", "1.5" };
        
        public readonly static String[] SomewhereSpear = new string[7] { "Somewhere Spear", "TETH", "Black", "5", "9", "1", "0.67" };
        
        public readonly static String[] LifefortheDaredevil = new string[7] { "Life for the Daredevil", "HE", "Pale", "7", "9", "1", "0.67" };
        
        public readonly static String[] Lantern = new string[7] { "Lantern", "TETH", "Black", "12", "18", "1", "0.33" };
        
        public readonly static String[] TodaysExpression = new string[7] { "Today's Expression", "TETH", "Black", "2", "3", "1", "1.5" };
        
        public readonly static String[] RapturousDream = new string[7] { "Rapturous Dream", "TETH", "White", "1", "2", "1", "1.5" };
        
        public readonly static String[] CherryBlossom = new string[7] { "Cherry Blossom", "TETH", "White", "1", "2", "3", "1.0" };
        
        public readonly static String[] CUTE!!! = new string[7] { "CUTE!!!", "TETH", "Red", "4", "6", "2", "1.0" };
        
        public readonly static String[] BearPaw = new string[7] { "Bear Paw", "HE", "Red", "6", "7", "2", "1.0" };
        
        public readonly static String[] BloodyDesire = new string[7] { "Bloody Desire", "HE", "Red", "4", "7", "1", "1.0" }; //+4 damage with temp 1-2
        
        
        public readonly static String[] Crier = new string[7] { "Crier", "HE", "White", "3", "3", "1", "1.5" };
        
        public readonly static String[] Harmony = new string[7] { "Harmony", "HE", "White", "30", "50", "1", "0.2" };
        
        public readonly static String[] Logging = new string[7] { "Logging", "HE", "Red", "15", "21", "1", "0.33" };
        
        public readonly static String[] FrostShard = new string[7] { "Frost Shard", "HE", "White", "6", "12", "1", "0.67" };
        
        public readonly static String[] GrinderMk4 = new string[7] { "Grinder Mk4", "HE", "Red", "1", "3", "6", "0.67" };
        
        public readonly static String[] Christmas = new string[7] { "Christmas", "HE", "White", "11", "13", "1", "0.5" };
        ...
        public readonly static String[] LaLuna = new string[7] { "La Luna", "WAW", "White", "8" "10" "1" "0.5" };
